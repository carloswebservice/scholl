                                            ...
                                            <?php 
                                              foreach ($docentes as $value) { ?>
                                                <tr>
                                                  ...
                                                  <td><?php echo $value->doc_nombres ?></td>
                                                  <td><?php echo $value->doc_apellidos ?></td>
                                                  <td><?php echo $value->doc_usuario ?></td>
                                                  <td><?php echo $value->tip_desc ?></td>
                                                  <td> <small class="label bg-green"> Activo</small></td>
                                                  <td>
                                                    <button type="button" class="btn btn-warning btn-xs" onclick="modificar('<?php echo $value->doc_id ?>')">Modificar</button>
                                                    <button type="button" class="btn btn-danger btn-xs" onclick="eliminar('<?php echo $value->doc_id ?>')">Eliminar</button>
                                                  </td>
                                                </tr>
                                              <?php }
                                            ?>
